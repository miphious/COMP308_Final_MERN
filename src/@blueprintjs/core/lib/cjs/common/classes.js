...
exports.ELEVATION_0 = elevationClass(card_1.Elevation.ZERO);
exports.ELEVATION_1 = elevationClass(card_1.Elevation.ONE);
exports.ELEVATION_2 = elevationClass(card_1.Elevation.TWO);
exports.ELEVATION_3 = elevationClass(card_1.Elevation.THREE);
exports.ELEVATION_4 = elevationClass(card_1.Elevation.FOUR);
...
exports.CALLOUT_TITLE = exports.CALLOUT + "-title";
...
exports.DIALOG_HEADER_TITLE = exports.DIALOG + "-header-title";
...
exports.HOTKEY_GROUP = exports.HOTKEY + "-group";
...
exports.NON_IDEAL_STATE_ACTION = exports.NON_IDEAL_STATE + "-action";
exports.NON_IDEAL_STATE_DESCRIPTION = exports.NON_IDEAL_STATE + "-description";
exports.NON_IDEAL_STATE_ICON = exports.NON_IDEAL_STATE + "-icon";
exports.NON_IDEAL_STATE_TITLE = exports.NON_IDEAL_STATE + "-title";
...
exports.RANGE_SLIDER = NS + "-range-slider";
...
exports.SPINNER_SVG_CONTAINER = exports.SPINNER + "-svg-container";
exports.SVG_SPINNER = NS + "-svg-spinner";
exports.TAB = NS + "-tab";
...
exports.TAG = NS + "-tag";
exports.TAG_REMOVABLE = exports.TAG + "-removable";
