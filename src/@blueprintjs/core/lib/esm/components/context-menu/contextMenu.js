...
var ContextMenu = /** @class */ (function (_super) {
    ...
    ContextMenu.prototype.render = function () {
        ...
        return (React.createElement("div", { className: Classes.CONTEXT_MENU_POPOVER_TARGET, style: this.state.offset },
            React.createElement(Popover, { backdropProps: { onContextMenu: this.handleBackdropContextMenu }, content: content, enforceFocus: false, hasBackdrop: true, isOpen: this.state.isOpen, minimal: true, modifiers: POPPER_MODIFIERS, onInteraction: this.handlePopoverInteraction, position: Position.RIGHT_TOP, popoverClassName: popoverClassName, popoverDidClose: this.props.didClose, target: React.createElement("div", null), transitionDuration: TRANSITION_DURATION })));
        var _a;
    };
...
export function show(menu, offset, onClose, isDarkTheme) {
    if (contextMenuElement == null) {
        ...
        contextMenu = ReactDOM.render(React.createElement(ContextMenu, { didClose: remove }), contextMenuElement);
    }
