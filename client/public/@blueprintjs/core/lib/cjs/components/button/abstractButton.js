...
var AbstractButton = /** @class */ (function (_super) {
    ...
    AbstractButton.prototype.getCommonButtonProps = function () {
        var _a = this.props, alignText = _a.alignText, fill = _a.fill, large = _a.large, loading = _a.loading, minimal = _a.minimal, small = _a.small;
    ...
    AbstractButton.prototype.renderChildren = function () {
        ...
        return (React.createElement(React.Fragment, null,
            loading && React.createElement(spinner_1.Spinner, { className: classnames_1.default(Classes.SMALL, Classes.BUTTON_SPINNER) }),
