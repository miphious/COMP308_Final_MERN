...
var Overlay = /** @class */ (function (_super) {
    ...
    function Overlay(props, context) {
        ...
        _this.maybeRenderChild = function (child) {
            ...
            return (React.createElement(react_transition_group_1.CSSTransition, { classNames: transitionName, onExited: _this.props.didClose, timeout: transitionDuration }, decoratedChild));
        };
